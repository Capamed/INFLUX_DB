...
var fluxQuery = 'from(bucket:"air_sensor") |> range(start: 0) |> filter(fn: (r) => r._measurement == "temperature")';
var myQuery = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c, values, tableMeta, o, e_1_1;
    var _d, e_1, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                _g.trys.push([0, 5, 6, 11]);
                _a = true, _b = __asyncValues(queryApi.iterateRows(fluxQuery));
                _g.label = 1;
            ...
            case 2:
                ...
                console.log("".concat(o._time, " ").concat(o._measurement, " in '").concat(o.location, "' (").concat(o.sensor_id, "): ").concat(o._field, "=").concat(o._value));
                _g.label = 3;
            case 3:
                _a = true;
                return [3 /*break*/, 1];
